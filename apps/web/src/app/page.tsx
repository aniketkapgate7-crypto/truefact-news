...
export default function HomePage() {
  ...
  const getDynamicHero = (): NewsArticle => {
    ...
    const regionHero = allNewsArticles.find(
      (a) => a.region === selectedRegion && (a.category === "Breaking" || a.category === "Tech" || a.category === "World")
    );
    if (regionHero) return regionHero;
    const anyRegionStory = allNewsArticles.find((a) => a.region === selectedRegion);
  ...
  const availableArticles = allNewsArticles.filter((a) => a.id !== activeHero.id);
        ...
        <div className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-4 shadow-sm space-y-2">
          ...
          {selectedRegion !== "All" && (
            <div className="text-xs text-gray-500 dark:text-gray-400 flex items-center justify-between pt-1 border-t border-gray-100 dark:border-gray-800">
              <span>
                Active Country Filter: <strong className="text-red-600 dark:text-red-400">{selectedRegion}</strong>
              </span>
              <button
          ...
          <div className="flex items-center justify-between gap-3 mb-6">
            <div className="flex items-center gap-3">
              ...
              <h2 className="font-serif text-xl font-bold text-gray-900 dark:text-white">
                Top Verified Stories {selectedRegion !== "All" && `(${selectedRegion})`}
              </h2>
            </div>
        ...
        <div className="rounded-2xl bg-gradient-to-r from-slate-900 via-gray-900 to-red-950 p-8 text-white flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl">
          <div className="space-y-2 text-center md:text-left">
            ...
            <p className="text-sm text-gray-300 max-w-xl">
              Cross-check any article claim in real-time across Snopes, Boom Live, Alt News, PolitiFact, and official government registries.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-screen-xl px-4 py-10 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 mb-10">
            <div className="col-span-2 sm:col-span-1">
              ...
              <p className="mt-2 text-sm text-gray-500 dark:text-gray-400 leading-relaxed">
                Real-time news ranked by truthiness % and multi-source corroboration. Country-filtered journalism you can verify.
              </p>
            </div>
            {[
              {
                title: "Categories",
                links: ["Politics", "World", "Business", "Tech", "Science", "Sports"],
              },
              {
                title: "Regions",
                links: ["Global 🌐", "India 🇮🇳", "USA 🇺🇸", "UK 🇬🇧", "Europe 🇪🇺", "Asia 🇯🇵"],
              },
              {
                title: "Legal",
                links: ["Privacy", "Terms", "Cookie Policy", "IFCN Methodology"],
              },
            ].map(({ title, links }) => (
              <div key={title}>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 border-t border-gray-100 dark:border-gray-800 pt-6">
            <p className="text-xs text-gray-400 dark:text-gray-600">
              © 2026 TrueFact News. AI-assisted analysis & Multi-Portal Corroboration Engine.
            </p>
